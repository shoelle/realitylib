...
RLAPI void DrawVRQuad(Vector3 position, Vector3 axis, float angle, float width, float height);
...
RLAPI void DrawVRCylinder(Vector3 position, Vector3 axis, float radius, float aspectRatio);
